...
$container['view'] = function ($c) {
    ...
    $rendered = $settings['renderer']; //d($rendered);

    // puede ser false o el directorio donde se guardará la cache
    $view = new \Slim\Views\Twig($rendered["template_path"] , ['cache' => false]);

    $twig = $view->getEnvironment(); // Vie Helpers

    $twig->addGlobal('twigGlobalVar', 'Hi Global Var!'); // Variable Global example
